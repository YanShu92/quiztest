...
export default function LoginPage() {
  ...
  useEffect(() => {
    ...
    const unsub = onValue(gameRef, (snap) => {
      ...
      if (data) {
        setTeams(
          data.teams || { slot1: null, slot2: null, slot3: null, slot4: null },
        );
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Đăng nhập vào game quiz trắc nghiệm 4 đội"
        />
      ...
      <div className="page login-page">
        <div className="login-card">
          <div className="login-logo">
            <h1>⚡ PHẦN THI TRẮC NGHIỆM</h1>
            <p>Hãy lựa chọn tên đội và vị trí để bắt đầu phần thi</p>
          </div>

          <div className="input-group">
            <label>Tên đội của đồng chí</label>
            <input
              type="text"
              ...
              return (
                ...
                >
                  <div
                    ...
                    style={{ color: isSelected ? tc.color : "" }}
                  >
                    {tc.emoji} {tc.label}
                  </div>
          ...
          <div className="host-link">
            <p>
              Quản trị viên? <a href="/host">→ Mở màn hình Host</a>
            </p>
          </div>
        </div>
      </div>
